...
This tool is in beta right now and only supports the iPad2,1 (K93AP), iPad2,2 (K94AP), iPad2,5 (P105AP), iPhone4,1 (N94AP), iPhone5,1 (N41AP), iPad3,1 (J1AP), iPhone5,2 (N42AP).
